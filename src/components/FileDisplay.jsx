        ...
        <main className='flex-1 p-4 flex flex-col gap-3 sm:gap-4 justify-center text-center pb-20 w-fit max-w-full mx-auto'>
            ...
            <div className="mx-auto flex flex-col text-left my-4">
                ...
                <div onClick={handleAudioReset} className="flex items-center justify-between gap-4 hover:text-blue-600 duration-200">
                    ...
                    <button className="specialBtn p-2 px-3 rounded-lg text-blue-400 flex items-center gap-2 font-medium"><p>Transcribe</p><i className="fa-solid fa-pen-nib"></i></button>
                </div>
            </div>
        </main>
    )
