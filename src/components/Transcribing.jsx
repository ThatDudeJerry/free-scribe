...
export default function Transcribing(props) {
    ...
    return (
        <div className="flex items-center flex-1 flex-col justify-center gap-10 md:gap-14 py-24 p-4 text-center pb-30">
            <div className="flex flex-col gap-2 sm:gap-4">
                <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'><span className='text-blue-400 bold'>Transcribing</span></h1>
